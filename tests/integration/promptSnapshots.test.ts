...
describe('Prompt Snapshot Tests', () => {
  ...
  test('INT-15: create spec prompt snapshot test', () => {
  ...
  test('INT-16: init steering prompt snapshot test', () => {
  ...
  test('INT-17: create custom steering prompt snapshot test', () => {
  ...
  test('INT-18: refine steering prompt snapshot test', () => {
  ...
  test('INT-19: delete steering prompt snapshot test', () => {
